---
name: testing
description: Testing methodology for full-stack applications, unit testing with Jest and Vitest, React component testing with React Testing Library, integration testing for Express APIs with Supertest, end-to-end testing with Playwright, test-driven development (TDD) practices, mocking strategies, test coverage, and CI/CD test integration. Applicable when writing tests, designing testable code, implementing test suites, or ensuring code quality through automated testing.
---
