---
name: openapi
description: OpenAPI specification (OAS) design, API documentation-first development, OpenAPI Generator for client/server SDKs, Swagger UI/Redoc for interactive documentation, validation and linting with Spectral, OpenAPI extensions for Prisma/Express, and maintaining OpenAPI contracts in a monorepo. Applicable when designing APIs, writing OpenAPI specifications, generating client SDKs, or validating API contracts.
---
