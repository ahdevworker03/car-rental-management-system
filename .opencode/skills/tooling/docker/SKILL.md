---
name: docker
description: Docker containerization for full-stack applications, Dockerfile authoring and optimization, multi-stage builds, layer caching strategies, .dockerignore configuration, security hardening (non-root user, minimal base images, secret management), resource limits, health checks, Docker Compose for multi-container applications, and Docker Scout vulnerability scanning. Applicable when containerizing applications, writing Dockerfiles, configuring Docker Compose, optimizing image size, or implementing container security best practices.
---
