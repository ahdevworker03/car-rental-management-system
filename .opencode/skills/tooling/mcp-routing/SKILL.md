---
name: mcp
description: Load when a task requires external tools, live data, official documentation, repository operations, database inspection, browser automation, deployment management, or other Model Context Protocol (MCP) capabilities. Determines whether an MCP should be used and selects the appropriate server.
---
