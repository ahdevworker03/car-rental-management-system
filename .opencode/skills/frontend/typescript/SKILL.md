---
name: typescript
description: TypeScript type system design, strict type safety, interface vs type decisions, generics usage, discriminated unions, type inference, utility types, tsconfig.json strictness flags, and ES module patterns. Applicable when writing .ts/.tsx files, defining types/interfaces, configuring TypeScript compiler options, or refactoring JavaScript to TypeScript.
---
