---
name: postgresql
description: PostgreSQL database management, query optimization, indexing strategies, performance tuning, security hardening, monitoring, and maintenance. Applicable when designing schemas, writing SQL queries, optimizing query performance, configuring PostgreSQL settings, implementing security, or monitoring database health.
---
