---
name: validation
description: Request validation with Zod, input validation middleware for Express, schema definition and composition, custom validation rules, error formatting, type inference from Zod schemas, validation of query parameters, URL parameters, request body, and headers. Applicable when validating user input, defining validation schemas, implementing validation middleware, or securing API endpoints against invalid data.
---
