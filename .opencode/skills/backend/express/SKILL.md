---
name: express
description: Express.js web framework development, middleware composition, routing configuration, request/response handling, error handling middleware, application structure, performance optimization, security best practices, and production deployment. Applicable when building REST APIs, configuring Express applications, writing middleware, defining routes, or deploying Express servers to production.
---
